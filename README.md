...
xychart-beta
    ...
    x-axis ["25.01", "26.01", "28.01", "29.01", "30.01", "02.02", "03.02", "04.02", "05.02"]
    y-axis "" 0 --> 5
    line [1, 1, 3, 1, 1, 2, 2, 3, 2]
...
xychart-beta
    ...
    x-axis ["Обобщенное (L-мом)", "Пирсона 3 типа (ММП)", "Пирсона 3 типа (L-мом)", "Обобщенное (ММП)", "Крицкого-Менкеля (ММП)", "Гумбеля (ММП)", "Гумбеля (L-мом)", "Гумбеля (Мом)"]
    y-axis "" 0 --> 7
    bar [7, 6, 6, 5, 4, 3, 3, 2]
