...
xychart-beta
    ...
    x-axis ["25.01", "26.01", "28.01", "29.01", "30.01", "02.02", "03.02"]
    y-axis "" 0 --> 5
    line [1, 1, 3, 1, 1, 2, 2]
...
xychart-beta
    ...
    x-axis ["Обобщенное (L-мом)", "Пирсона 3 типа (ММП)", "Обобщенное (ММП)", "Крицкого-Менкеля (ММП)", "Пирсона 3 типа (L-мом)", "Гумбеля (ММП)", "Гумбеля (L-мом)", "Гумбеля (Мом)"]
    y-axis "" 0 --> 7
    bar [7, 5, 5, 4, 3, 3, 3, 2]
