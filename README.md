...
**Обновлено:** 29.01.2026 21:33 МСК 

```mermaid
    xychart-beta
    title "📈 Активность за последние 15 дней"
    x-axis [
      "25.01", "26.01", "28.01", "29.01"
    ]
...
```mermaid
    ...
    ""Гумбеля (Мом)"", ""Гумбеля (L-мом)"", ""Гумбеля (ММП)"", ""Крицкого-Менкеля (ММП)"", ""Пирсона 3 типа (L-мом)"", ""Обобщенное (ММП)"", ""Пирсона 3 типа (ММП)"", ""Обобщенное (L-мом)""
    1, 1, 1, 2, 2, 2, 3, 5
```
